...
namespace CTP
{
	...
	public enum struct EnumOptionsType : Byte
	{
		Call = (Byte)'1',
		Put = (Byte)'2'
	};

	public enum struct EnumCombinationType : Byte
	{
		///期货组合
		Future = (Byte)'0',
		///垂直价差BUL
	...
	public enum struct MaxMarginSideAlgorithmType : Byte
	{
		No = (Byte)'0',
		Yes = (Byte)'1'
	};
	...
	public enum struct EnumBizType : Byte
	{
		///期货
		Future = (Byte)'1',
		///证券
	...
	public ref struct ThostFtdcInstrumentField
	{
		...
		double	StrikePrice;
		///期权类型
		EnumOptionsType	OptionsType;
		///合约基础商品乘数
		double	UnderlyingMultiple;
		///组合类型
		EnumCombinationType	CombinationType;
		///最小买下单单位
		int	MinBuyVolume;
		///最小卖下单单位
		int	MinSellVolume;
