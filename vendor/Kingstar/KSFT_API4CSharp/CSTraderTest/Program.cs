...
namespace CSTraderTest
{
    ...
    class testTraderApi
    {
        ...
        string FRONT_ADDR = "tcp://xxx.xxx.xxx.xxx:xxxxx";  // 前置地址
        string BROKER_ID = "xxxxxxxx";                       // 经纪公司代码
        string INVESTOR_ID = "xxxxxxxx";                    // 投资者代码
        string PASSWORD = "xxxxxx";                     // 用户密码
        string INSTRUMENT_ID = "xxxxxxxx";
        ...
        void OnRspQryInstrument(ThostFtdcInstrumentField pInstrument, ThostFtdcRspInfoField pRspInfo, int nRequestID, bool bIsLast)
        {
            ...
            DebugPrintFunc(new StackTrace());
            Console.WriteLine("{0} {1}", pInstrument.InstrumentID, pInstrument.InstrumentName);
